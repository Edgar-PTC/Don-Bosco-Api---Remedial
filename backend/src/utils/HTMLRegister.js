const HTMLRegisterEmail = (Code, name, lastname) => {
    ...
    return `
        <html lang="en">
            ...
            <body style="margin: 0; padding: 5px; background-color: #456cb0; font-family: Arial, sans-serif;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #456cb0;">
                    <tr>
                                ...
                                <tr>
                                    <td style="padding: 40px 30px; text-align: center;">
                                        ...
                                        <p style="font-size: 16px; line-height: 1.5; color: #555; margin: 0 0 30px 0;">
                                            Hola ${name} ${lastname}. Gracias por tu interés en nuestra institución.<br>
                                            Estamos a punto de terminar, solo debemos verificar tu correo.<br>
                                            Ingresa el siguiente código para completar tu registro:
                                        </p>
                                        
                                        <!-- Tabla del código (horizontal) -->
